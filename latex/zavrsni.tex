...
\kljucnerijeci{višedretvenost, računalni vid, detekcija pješaka, paralelizacija, histogram orijentacija gradijenata}
\end{sazetak}

\engtitle{Multi-threaded Implementation of Algorithm for Calculation of Histogram of Oriented Gradients in Images}
\begin{abstract}
Many algorithms used in computer vision and computing in general perform similar or identical operations on a large amount of pixels or data. Such algorithms are perfect for multithreaded implementation. Main focus of this thesis is multithreaded implementation of algorithm for calculation of histogram of oriented gradients. Multiple parallelization options are implemented and analyzed. Possible problems with less effective implementations are explainde and analyzed. Finally the effectivness of the implementation is analyzed by training and testing a linear classifier using feature vectors calculated using this algorithm.

\keywords{multithreading, computer vision, pedestrian detection, parallelization, histogram of oriented gradients}
\end{abstract}
